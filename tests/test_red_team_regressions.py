...
# multiprocessing spawn starts a fresh interpreter and does not preserve the
# conftest path mutation; make the canonical src flat modules resolvable before
# importing src.bucket_manager in both parent and child processes.
